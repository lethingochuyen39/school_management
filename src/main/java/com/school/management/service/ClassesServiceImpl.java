...
public class ClassesServiceImpl implements ClassesService {
    ...
    public Classes updateClasses(Long id, Classes classes) {
        ...
        // .orElseThrow(() -> new ClassesNotFoundException("Metric not found with id: "
        // + id));

        // if (existingClasses != null &&
        // !existingClasses.getName().equals(classes.getName()) &&
        // !existingClasses.getName().equals(classes.getTeacher())) {
        // if (classesRepository.existsByName(classes.getName())) {
        // throw new IllegalArgumentException("Academic year with the same name already
        // exists.");
        // }
        // }
        classes.setId(id);
